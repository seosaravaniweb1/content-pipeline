...
#: ستون‌هایی که این برنامه حق نوشتن در آن‌ها را ندارد (نام داخلی یا عنوان ستون)
...
class SheetSettings:
    ...
    title_column: str = ""
    #: عنوان ستونی که آدرس صفحه‌ی منبع در آن است (اختیاری)
    sources_column: str = ""
    ...
    def from_mapping(cls, data: dict | None) -> "SheetSettings":
        ...
        return cls(
            ...
            sources_column=str(data.get("sources_column", "") or ""),
